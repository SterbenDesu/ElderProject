      ...
      <div className="mt-8 grid gap-5 lg:grid-cols-[1fr_0.72fr]">
        <div className="rounded-[2rem] bg-white p-6 text-stone-700 shadow-sm ring-1 ring-stone-200">
          ...
          <p className="mt-4 leading-7">
            Supabase authentication and basic profile storage are available when configured, but helper applications, booking, payment processing, and admin functionality are not active yet. Stripe, payment logic, and admin actions have not been added.
          </p>
