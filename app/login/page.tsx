      ...
      <div className="mt-8 grid gap-5 lg:grid-cols-[1fr_0.72fr]">
        <div className="rounded-[2rem] bg-white p-6 text-stone-700 shadow-sm ring-1 ring-stone-200">
          ...
          <p className="mt-4 text-lg leading-8">
            Future login will use a real authentication provider only after the authentication phase begins. No session, protected route, database record, or admin access is active here.
          </p>
          ...
          <Link href="/safety" className="mt-6 inline-flex min-h-12 items-center rounded-full bg-forest px-5 py-3 font-semibold text-white transition hover:bg-stone-800">
