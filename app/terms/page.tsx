  ...
  return (
    <section className="mx-auto max-w-5xl px-5 py-12 lg:px-8 lg:py-16">
      <PageIntro
        ...
        description="This page is a placeholder for future Terms of Service. It is not final legal text and should not be used for a public launch until reviewed by a qualified professional."
      />
