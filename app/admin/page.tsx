...
export default function AdminPage() {
  return (
    <section className="mx-auto max-w-5xl px-5 py-12 lg:px-8 lg:py-16">
      ...
      <h1 className="mt-3 text-4xl font-bold tracking-tight text-forest sm:text-5xl">Admin</h1>
      <div className="mt-8 grid gap-5 lg:grid-cols-[1fr_0.72fr]">
        <div className="rounded-[2rem] bg-white p-6 text-stone-700 shadow-sm ring-1 ring-stone-200">
          ...
          <p className="mt-4 leading-7">
            Supabase authentication and basic profile storage are available when configured, but booking, payment processing, and admin database management are not active yet. Stripe, payment logic, and admin actions have not been added.
          </p>
