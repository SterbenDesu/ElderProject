  ...
  return (
    <section className="mx-auto max-w-5xl px-5 py-12 lg:px-8 lg:py-16">
      <PageIntro
        ...
        description="This page is a placeholder for a future Privacy Policy. It is not final legal text and should not be used for launch until data collection, retention, security, and user rights are reviewed by qualified professionals."
      />
