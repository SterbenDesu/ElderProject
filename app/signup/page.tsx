      ...
      <div className="mt-8 grid gap-5 lg:grid-cols-[1fr_0.72fr]">
        <div className="rounded-[2rem] bg-white p-6 text-stone-700 shadow-sm ring-1 ring-stone-200">
          ...
          <p className="mt-4 text-lg leading-8">
            Future signup will collect only the minimum information needed after privacy, terms, and authentication flows are designed. This page does not create accounts or store data.
          </p>
          ...
          <Link href="/services" className="mt-6 inline-flex min-h-12 items-center rounded-full bg-forest px-5 py-3 font-semibold text-white transition hover:bg-stone-800">
